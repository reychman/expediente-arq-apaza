...
S(Principio de responsabilidad)
    donde vive: GestorDePedidos().ProcesarPedido
...
O(ABIERTO/CERRADO)
    donde vive: GestorDePedidos.ProcesarPedido en el switch
...
I(segregacion de intefaces)
    donde vive: IEmpleadoDeFarmacia y clase Cajero
...
D(inversion de dependencias)
    donde vive: GestorDePedidos 
    esta atado a implementaciones especificas BaseDeDatosMySql y CorreoSmtp en lugar de trabajar con interfaces
