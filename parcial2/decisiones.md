...
Avisos de vencimiento de membresia (Observer) se tendria que abrir y modificar el modulo de los socios, y eso es exactamente lo que resuelve Observer, el modulo de socios seria el sujto que solo avisa que esto se vencio y cualquier modulo interesado se suscribe sin que el sujeto sepa quien es ni cuantos son.
...
situacion 3 Integración con pasarela de pago externa (adapter)
